	...
	(0, _ajax.login)().then(function () {
		new _vue2.default({
			...
			mounted: function mounted() {
				...
				_ajax.sheet.list().then(function (res) {
					self.sheet = res.data;
				});

				_ajax.clerk.list().then(function (res) {
					self.clerk = res.data;
				});
			}
		});
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/.0.25.0@css-loader/index.js!./../../node_modules/.2.2.3@less-loader/index.js!./plan.less", function() {
				var newContent = require("!!./../../node_modules/.0.25.0@css-loader/index.js!./../../node_modules/.2.2.3@less-loader/index.js!./plan.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
